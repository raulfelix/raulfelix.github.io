  ...
  <section className="content-row beige">
    <div className="f-grid f-row">
      <div className="f-1">
        ...
        <p>I enjoy technical challenges and write a lot of <em>HTML</em>, <em>CSS</em> and <em>Javascript</em> and have plenty experience with <em>React</em>, <em>React Native</em> and <em>Vue.js</em>.
        </p>
      </div>
    </div>
  </section>
